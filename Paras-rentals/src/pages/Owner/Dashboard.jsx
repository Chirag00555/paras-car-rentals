...
const Dashboard = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
      <Title title="Admin Dashboard" subTitle="Monitor overall platform peformance including total cars, bookingsm revenue and recent activities"/>

      <div className='grid sm:grid-cols md:grid-cols-3 lg:grid-cols-4 gap-6 my-8 max-w-3xl'>
