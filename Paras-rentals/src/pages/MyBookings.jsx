            ...
            key={booking._id} className='grid grid-cols-1 md:grid-cols-4 gap-6 p-6 border border-borderColor rounded-lg mt-5 first:mt-12'>
                ...
                <div className='md:col-span-2'>
                    <div className='flex items-center gap-2'>
                        ...
                        <p className={`px-3 py-1 text-xs rounded ${booking.status === 'confirmed' ? 'bg-green-400/15 text-green-600' : 'bg-red-400/15 text-red-600'}`}>{booking.status}</p>
                    </div>
                    ...
                    <div className='flex items-start gap-2 mt-3'>
                        ...
                        <div>
                            ...
                            <p>{booking.pickupDateTime?.split("T")[0]} To {booking.returnDateTime?.split("T")}</p>
                        </div>
                    </div>
